...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-violet-600/20 rounded-full blur-[100px]" />
      ...
      <div className="glass-panel w-full max-w-md p-8 relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 mt-1 text-sm">Join ERGOAI today</p>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-slate-900/80 text-slate-500">Or sign up with username</span>
          </div>
        </div>
